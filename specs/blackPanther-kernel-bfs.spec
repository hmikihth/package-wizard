...
%endif
    ...
    LC_ALL=C %{patches_dir}/scripts/apply_patches --patch_dir=%{build_dir}/%{patches_ver}/patches-bp16
    LC_ALL=C %{patches_dir}/scripts/apply_patches --patch_dir=%{build_dir}/%{patches_ver}/patches-fc2x
    LC_ALL=C %{patches_dir}/scripts/apply_patches --patch_dir=%{build_dir}/%{patches_ver}/patches-pclx
    LC_ALL=C %{patches_dir}/scripts/apply_patches --patch_dir=%{build_dir}/%{patches_ver}/patches-stable
