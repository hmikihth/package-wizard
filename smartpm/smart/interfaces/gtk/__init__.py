...
def splitted_error():
	print _("ERROR: The Smartpm package is splitted in few subpackages")
	print _(" - smart: Core of the Smart Package Manager")
	print _(" - smart-gui-*: The Gtk/Qt4 GUI frontend")
